...
export class AddComponent implements OnInit {
  ...
  constructor(public userService: UsersService, private fb: FormBuilder, public postService: PostService, public router: Router,public category_service:CategoriesService) {
  ...
  async ngOnInit() {
    ...
    await this.category_service.categoryList().then(data=>{
